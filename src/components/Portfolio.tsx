...
const Portfolio = () => {
  const portfolioItems = [
    ...
    { title: "DNA Affi", description: "Fantoche amarelo", image: dna },
    ...
    { title: "Monstro Rosa 2", description: "Variação rosa", image: monstroRosa2 },
    ...
    { title: "Monstro Amarelo 2", description: "Variação amarela", image: monstroAmarelo2 },
