...
const Portfolio = () => {
  const portfolioItems = [{
    ...
    title: "Monstro Rosa",
    description: "Fantoche peludo rosa",
    image: monstroRosa
  }, {
    ...
    description: "Variação amarela",
    image: monstroAmarelo2
  }, {
    title: "Monstro Azul 2",
    description: "Variação azul",
    image: monstroAzul2
  }, {
    title: "Menina Sice",
